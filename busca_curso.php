            ...
            <div class="row">
                ...
                <nav class="col-md-2" id="barraLateral">
                    ...
                    <aside class="span3 sidebar">
                        ...
                        <ul id="menu" class="nav affix">
                            ...
                            <li><img id="logo" src="imagens/logo.png" width="130" alt="logo"/></li>
                ...
                <div class="col-md-10" id="conteudo">
                    ...
                    <section> 
                        ...
                        if ($opcao == "codigo") {
                            $sql_seleciona = "SELECT codigo_curso, nome, codigo_ocde, id FROM curso WHERE codigo_curso='$chave'";
                            $resultado = seleciona($sql_seleciona);
                        } else if ($opcao == "nome") {
                            $sql_seleciona = "SELECT codigo_curso, nome, codigo_ocde, id FROM curso WHERE nome LIKE '%$chave%'";
                            $resultado = seleciona($sql_seleciona);
                        } else if ($opcao == "codigo_ocde") {
                            $sql_seleciona = "SELECT codigo_curso, nome, codigo_ocde, id FROM curso WHERE codigo_ocde='$chave'";
                            $resultado = seleciona($sql_seleciona);
                        } else if ($opcao == "grau") {
                            $sql_seleciona = "SELECT codigo_curso, nome, codigo_ocde, id FROM curso WHERE grau_academico='$chave'";
                            $resultado = seleciona($sql_seleciona);
                        }
                        ?>
                            ...
                            <table border="0">
                                ...
                                <tbody>
                                    ...
                                    while ($res = mysql_fetch_assoc($resultado)) {
                                        ...
                                        '<form style="display: inline;" method="post" action="bd_exclusao_curso.php" > <input type="text" style="display: none;" name="id" value="' . $res['id'] . '">'
