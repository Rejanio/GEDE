                ...
                <div class="col-md-10" id="conteudo">
                    ...
                    <section> 
                        ...
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" class="btn btn-default" onclick="location.href = 'adicao_curso.php'"> Adicionar curso</button>
                            <button type="button" class="btn btn-default" onclick="location.href = 'listagem_cursos.php'">Listar cursos</button>
                        ...
                        <?php
                        conexao();
                        $count = mysql_query("SELECT COUNT(*) AS Total FROM curso");
